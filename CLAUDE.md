...
- 単穴: 3位（1頭）
- 連下最上位: 4位（1頭）
- **連下: 5～6位（最大2頭、2点以上のみ）** ← 修正箇所
- 補欠: 7位以降または1点以下
- 無: 0点

**連下の合計:** 連下最上位（1頭）+ 連下（最大2頭）= **最大3頭**

**影響範囲:**
- `/admin/predictions-batch` (南関・一括入力)

**⚠️ 重要な訂正（2026-02-12）:**
- 上記の説明で「連下: 5～6位（最大3頭）」と記載していましたが、正しくは**「連下: 5～6位（最大2頭）」**です
- 連下最上位（4位・1頭）+ 連下（5～6位・最大2頭）= 合計最大3頭
- 全4ページ（predictions-batch, predictions-manager, predictions-manager-jra, predictions-manager-jra-batch）の表示ラベルを「1~2頭」に修正しました
